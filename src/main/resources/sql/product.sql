...
INSERT INTO products (id, code, name, category, brand, type, description) VALUES (2, 'P002', 'Party Cosplay Player Unknown Battlegrounds Clothes Hallowmas PUBG', 'Men''s Clothing', 'No Brand', null, 'Suitable for adults and children.');
